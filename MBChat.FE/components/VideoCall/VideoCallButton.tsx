...
//     useEffect(() => {
//       if (!pc.current && !userContext?.userInfomation.offerDescription && userContext?.userInfomation.gettingCall && chatContext?.chats.id) {
//         create();
//       }
...
//                     gettingCall: false
//                   })
//                   router.push(`/(tabs)/chats/${chatContext?.chats.id}`);
//                   console.log("close", userContext?.userInfomation.username)
//                   break;
//             }
//         });
